...
if __name__ == "__main__":
    ...
    parsedAll = True
    matchedAllGold = True
    matchedAllScore = True
    matchedAllParses = True
    for i in range(l):
        ...
        if vitTree is None:
            ...
            matchedAllGold = matchedAllGold and matchedGold
            matchedAllScore = matchedAllScore and matchedScore
            matchedAllParses = matchedAllParses and matchedParses

    if parsedAll and matchedAllGold and matchedAllScore and matchedAllParses:
        print "Nice job, CKY produces correct viterbi parses!"
