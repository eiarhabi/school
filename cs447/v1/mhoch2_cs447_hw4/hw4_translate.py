...
class IBMModel1:    
    def __init__(self, trainingCorpusFile):
        ...
        self.tLenProb = defaultdict(lambda: defaultdict(int))
        self.wTranProb = defaultdict(lambda: defaultdict(int))
...
if __name__ == "__main__":
    ...
    # Train model
    model.trainUsingEM(20); # may want to use fewer than 10 iterations during dev
