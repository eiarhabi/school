...
def runTests(modelStr, languageModel, sen, testCorpus):
    ...
    if isinstance(modelSen, list):
        if len(modelSen) > 1:
            if isinstance(modelSen[0], basestring):
                print "pass"
                senTestPassed = True
...
if __name__ == '__main__':
    ...
    smoothedBigram = SmoothedBigramModel(corpus)
   ...
   #test the models
    ...
    runTests("smoothed_bigram", smoothedBigram, sen, corpus)
